    ...
    <CalculatorPage
      ...
      infoContent={
        <>
          ...
          <h3 className="mt-7 text-lg font-semibold text-slate-900">
            What does the EPF calculator show?
          </h3>
          ...
          <h3 className="mt-7 text-lg font-semibold text-slate-900">
            Why can your EPF balance differ from this estimate?
          </h3>
